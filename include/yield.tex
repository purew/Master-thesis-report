...
%		\end{table}
		\ctable[ caption = Different components' spread parameters. The values are spread uniformly. Some of the values are taken from PH25 as they aren't defined in the PPH25 manual.,
			...
			{
				Component & Parameter & Spread \\\hline
				...
				TiWSi resistor & Resistance & $\pm$\unit[8]{\%} \\\hline
			}
	...
	\section{Amplifier IF1}\label{sec:yieldif1}
		...
		\begin{table}[hbt!]
			...
			\begin{tabular}{ l l }
				...
				Power Consumption &  $\unit[290\pm 40]{mW}$
			\end{tabular}
		\end{table}
	...
	\section{Amplifier IF2}\label{sec:yieldif2}
		...
		\begin{table}[hbt!]
			...
			\begin{tabular}{ l l }
				...
				Power Consumption &  $\unit[550\pm 70]{mW}$
			\end{tabular}
		\end{table}
...
%		\end{figure}
	...
	\section{Mixer}
		...
		\begin{table}[hbt!]
			...
			\begin{tabular}{ l l l l }
				Parameter & Performance & Performance & Unit \\\hline
				Band & 2.9--3.4 & 3.1--3.3 & GHz \\\hline
				...
				$P_{1dB}$ (input) & $13\pm 0$ & $13\pm 0.5$ & dBm \\
			\end{tabular}
		\end{table}
	...
	\section{Chip}
		Yield analysis of chip conversion gain in \autoref{fig:yield_chip_gain}. 
