...
\else
	% Titlepage for Chalmers
	\begin{titlepage}
	\begin{adjustwidth}{}{-2cm}
	
	\AddToShipoutPicture{
	\backgroundpic{-4}{0}{fig/chalmers}
	\backgroundpicp{105}{475}{fig/front_v3}{1.15\textwidth}}
	\mbox{}
	\vfill
	\addtolength{\voffset}{2cm}
	\begin{flushleft}
		{\noindent {\Huge S Band Multi-function Down-converter \\
		\vspace*{5pt}
		GaAs MMIC} \\[0.5cm]
		%{\noindent {\Huge S Band Multi-function Down-converter MMIC} \\[0.5cm]
